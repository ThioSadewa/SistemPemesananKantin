  ...
  return (
    <View>
      ...
      <View style={style.menuMakanan}>
        <TouchableOpacity>
          <Image style={style.makanan} resizeMode='cover' source={require('./src/assets/images/nasi-goreng-pedas_43.jpeg')}/>
          <Text style={style.namaMenu}>Nasi Goreng</Text>
          <Text style={style.hargaMenu}>Rp 20.000</Text>
        </TouchableOpacity>
        <TouchableOpacity>
          <Image style={style.makanan} resizeMode='cover' source={require('./src/assets/images/burger.png')}/>
      ...
      <View style={style.menuMinuman}>
        <TouchableOpacity>
          <Image style={style.minuman} resizeMode='cover' source={require('./src/assets/images/jus.png')}/>
          <Text style={style.namaMenu}>Jus Jeruk</Text>
          <Text style={style.hargaMenu}>Rp 15.000</Text>
        </TouchableOpacity>
        <TouchableOpacity>
          <Image style={style.minuman} resizeMode='cover' source={require('./src/assets/images/teh.png')}/>
      ...
      {/* footer by ray */}
        <Text style={style.footer}>RAY DESAIN</Text>
      {/* footer by ray */}
    </View> 
  );
};
